...
export default function FullWidthTabs({tab}) {
  ...
  return (
    <div className={classes.root}>
        <CssBaseline />
      <AppBar style={{ position: "fixed", top: 0 }} className={classes.main} position="static" color="default">
          <Typography className={classes.title} variant="h6">Admin Templates </Typography>
        <Tabs
          value={value}
        ...
        >
            ...
            <Tab onClick={()=>{
             ...
             }} label="Designations" {...a11yProps(0)} />
            {/* </Link> */}
