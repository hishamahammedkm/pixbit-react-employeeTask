...
const headCells = [
  ...
  { id: 'fat', numeric: true, disablePadding: false, label: 'Joinig Date' },
  { id: 'carbs', numeric: true, disablePadding: false, label: 'Date of Birth' },
  { id: 'protein', numeric: true, disablePadding: false, label: 'Gender' },
  { id: 'protein', numeric: true, disablePadding: false, label: 'Designation' },
  { id: 'protein', numeric: true, disablePadding: false, label: 'Email' },
  { id: 'protein', numeric: true, disablePadding: false, label: 'Profile Picture' },
];
